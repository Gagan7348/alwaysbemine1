...
//! yes - Music Importing
import yesmusic1 from "./assets/AudioTracks/Gehra Hua Dhurandhar 320 Kbps.mp3";
import yesmusic2 from "./assets/AudioTracks/Love_LoveMeLikeYouDo.mp3";
...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
        Swal.fire({
          title: "Avani, I love you so much! But cutie, itna jaldi haan kyu bola? Thoda to pareshan kar leti, thoda nakhre dikha leti! My heart melts for you, but you made me wait for nothing. You’re my sweetest dream, and I wanted to chase you a little more. Thank you for making me the happiest, but next time, let me earn your yes with a few more tears and smiles! 🥺❤️✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
        Swal.fire({
          title: "Baby, my heart belongs to you. You are my forever, my soulmate, my best friend. Will you be my Valentine and walk with me through every season of life? 💞 Every beat of my heart whispers your name. Will you be the love of my life, always?",
        width: 800,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
  ...
  useEffect(() => {
    if (noCount == 25) {
        Swal.fire({
          title: "Avani, my love for you is infinite, like the stars that shine for you every night. I’ll wait for you, hoping you’ll let me be your Valentine. True love never gives up; it only grows deeper. Please say ‘Yes’ and let’s write our forever story together. 💖🌹",
        width: 850,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
        ...
        {yesPressed && noCount>3 ? (
          ...
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center">
              CUTIEEEEEEEEEEEEEEEEEEEE, will you be my Valentine? You are the reason my heart beats, the dream I never want to end. Will you let me be the one who loves you endlessly?
            </h1>
